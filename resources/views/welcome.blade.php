...
// $('#idPegawai').on('change', function() {
    ...
    {{-- Bagian yang hanya ditampilkan untuk super admin dan admin
...
<div class="block block-rounded">
    ...
    <div class="row p-0 m-0"> --}}
        {{-- Konten tab dan tabel --}}
    {{-- </div>
</div>
@endcanany --}}

{{-- Bagian yang hanya ditampilkan untuk siswa --}}
{{-- @can('siswa')
<li class="breadcrumb-item">
    <a class="link-fx" href="javascript:void(0)">
        {{ $title }} {{ ucwords(Auth::user()->tr_kelas->first()->kelas->namaKelas) }}
    </a>
</li>
@endcan --}}

{{-- Bagian ini akan ditampilkan untuk pengguna selain super admin, admin, dan siswa --}}
{{-- @cannotany(['super.admin', 'admin', 'siswa']) --}}
{{-- Bagian khusus untuk pengguna lainnya --}}
...
{{-- @endcannotany --}}
...
<body class="m-0 p-0">
    <header>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container">
                <a class="navbar-brand fw-bold" href="#">SDN LEMAHBANG</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navHead" aria-controls="navHead" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                  </button>
              
                <div class="navbar" id="navHead">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 mb-md-0 gap-4">
                        <li class="nav-item">
                            <a class="nav-link link-light fw-medium " aria-current="page"
                                    href="#"><small>HOME</small></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link link-light fw-medium" aria-current="page"
                                    href="#"><small>PROFIL</small></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link link-light fw-medium" aria-current="page"
                                    href="#"><small>SEJARAH</small></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link link-light fw-medium" aria-current="page"
                                    href="#"><small>BERITA</small></a>
                        </li>
                        <li class="nav-item">
