        ...
        <div class="col-xxl-3 col-lg-4 col-12">
            <div class="row m-0 mb-3 d-none d-lg-block">
                <div class="bg-white rounded shadow-sm p-2">
                    <select name="bulanFoto" id="bulanFoto" class="form-select">
            ...
            <div class="row m-0 p-0 mb-3">
                <h5 class="p-0 m-0 mb-1">GALERI</h5>
                ...
                <ul class="navbar-nav">
                    <li class="nav-main-item">
                        <a class="nav-main-link {{ Request::routeIs('galeri_foto') ? 'active' : '' }}"
                            ...
                            <span class="nav-main-link-name"><i class="fa-brands fa-slack mx-2"></i>Foto</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link {{ Request::routeIs('galeri_video') ? 'active' : '' }}" href="{{ route('galeri_video') }}">
                            <span class="nav-main-link-name"><i class="fa-brands fa-slack mx-2"></i>Video</span>
                        </a>
                    </li>
                </ul>
            </div>
