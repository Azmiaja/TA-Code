{{-- ========================= MODAL INSERT ================== --}}
<div class="modal fade" id="modalBerita" tabindex="-1" role="dialog" aria-labelledby="modalInsert"
    aria-hidden="true">
            ...
            <div class="block block-rounded block-transparent mb-0">
                <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                        <button type="button" class="btn-block-option" id="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            <i class="fa fa-fw fa-times"></i>
                        </button>
                    </div>
                </div>
                <div class="block-content fs-sm">
                    <form action="POST" id="formBerita" enctype="multipart/form-data">
