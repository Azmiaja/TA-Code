...
! function (n) {
    ...
    function St(t, e, n, a) {
        var r, o, i, l, s, u, c = t.aoData[e],
            ...
            d = [];
        if (null === c.nTr) {
            for (r = n || y.createElement("tr"), c.nTr = r, c.anCells = d, r._DT_RowIndex = e, vt(t, c), l = 0, s = t.aoColumns.length; l < s; l++) i = t.aoColumns[l], (o = (u = !n) ? y.createElement(i.sCellType) : a[l])._DT_CellIndex = {
                row: e,
                column: l
    ...
    function yt(t) {
        ...
        if (i && Ct(t.aoHeader, r), P(r).children("tr").children("th, td").addClass(l.sHeaderTH), P(o).children("tr").children("th, td").addClass(l.sFooterTH), null !== o)
            for (var u = t.aoFooter[0], c = 0, f = u.length; c < f; c++)(a = s[c]).nTf = u[c].cell, a.sClass && P(a.nTf).addClass(a.sClass)
    }
    ...
    function Yt(t, e, n) {
        ...
        return t._iDisplayStart = a, o && (R(t, null, "page", [t]), n && v(t)), o
    }
    ...
    function Kt(t) {
        ...
        var r = n.sX,
            ...
            u = (f.length || (f = null), P(d, {
                ...
                width: n.sXInner || "100%"
            }).append(u.removeAttr("id").css("margin-left", 0).append("top" === s ? l : null).append(e.children("thead"))))).append(P(d, {
                class: i.sScrollBody
            }).css({
                position: "relative",
                overflow: "auto",
            ...
            }).append(c.removeAttr("id").css("margin-left", 0).append("bottom" === s ? l : null).append(e.children("tfoot"))))), u.children()),
            h = d[0],
            i = d[1],
            p = f ? d[2] : null;
        return r && P(i).on("scroll.DT", function (t) {
            var e = this.scrollLeft;
            h.scrollLeft = e, f && (p.scrollLeft = e)
        }), P(i).css("max-height", o), n.bCollapse || P(i).css("height", o), t.nScrollHead = h, t.nScrollBody = i, t.nScrollFoot = p, t.aoDrawCallback.push({
            fn: Qt,
            sName: "scrolling"
        }), u[0]
    }
    ...
    function ae(t, e) {
        if (!t) return 0;
        t = P("<div/>").css("width", k(t)).appendTo(e || y.body), e = t[0].offsetWidth;
        return t.remove(), e
    }
    ...
    function le(t) {
        for (var e = t.aoColumns, n = I(t), a = t.oLanguage.oAria, r = 0, o = e.length; r < o; r++) {
            var i = e[r],
                ...
                u = i.nTh;
            u.removeAttribute("aria-sort"), i = i.bSortable ? s + ("asc" === (0 < n.length && n[0].col == r ? (u.setAttribute("aria-sort", "asc" == n[0].dir ? "ascending" : "descending"), l[n[0].index + 1] || l[0]) : l[0]) ? a.sSortAscending : a.sSortDescending) : s, u.setAttribute("aria-label", i)
        }
    }
    ...
    function pe(n, t, e) {
        ...
        if (t && t.time) {
            ...
            if (-1 !== P.inArray(!1, l)) n._bLoadingState = !1, e();
                ...
                l = n.iStateDuration;
                if (0 < l && t.time < +new Date - 1e3 * l) n._bLoadingState = !1, e();
                else if (t.columns && o.length !== t.columns.length) n._bLoadingState = !1, e();
                else {
    ...
    var Ie = [],
        ...
        Le = (e("rows()", function (e, n) {
            ...
            return n._aData = t, Array.isArray(t) && n.nTr && n.nTr.id && b(e[0].rowId)(t, n.nTr.id), bt(e[0], this[0], "data"), this
        }), e("row().node()", function () {
            var t = this.context;
            ...
            var n = new B(e),
                a = (n.on("stateSaveParams", function (t, e, n) {
                    ...
                    if (null === t || t === N || e) {
                        for (o = [], i = 0, l = d.length; i < l; i++)
                            for (r = d[i], s = 0; s < p; s++) u = {
                                row: r,
                                column: s
                            }, e ? (c = f[r], t(u, S(a, r, s), c.anCells ? c.anCells[s] : null) && o.push(u)) : o.push(u);
                        return o
                    }
        ...
        }), C.version = "1.12.1", C.settings = [], C.models = {}, C.models.oSearch = {
            bCaseInsensitive: !0,
            sSearch: "",
            bRegex: !1,
            bSmart: !0,
    ...
    function Ue(t, e, n) {
        ...
        if (j.moment) {
            ...
            if (!(a = e ? j.luxon.DateTime.fromFormat(t, e) : j.luxon.DateTime.fromISO(t)).isValid) return null;
            a.setLocale(n)
    ...
    function Ve(s) {
        return function (a, r, o, i) {
            ...
            return C.ext.type.order[l] || (C.ext.type.detect.unshift(function (t) {
                ...
                function (t, e) {
                    if (null !== t && t !== N || (t = "--now" === i ? (n = new Date, new Date(Date.UTC(n.getFullYear(), n.getMonth(), n.getDate(), n.getHours(), n.getMinutes(), n.getSeconds()))) : ""), "type" === e) return l;
                    if ("" === t) return "sort" !== e ? "" : Ue("0000-01-01 00:00:00", null, o);
